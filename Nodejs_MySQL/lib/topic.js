...
exports.create_proces = function(request, response) {
    var body = '';
...
exports.update_process = function(request, response) {
    ...
    request.on('end', function(){
        ...
        db.query('UPDATE topic SET title=?, description=?, author_id=? WHERE id=?', [post.title, post.description, post.author, post.id], function(error, topic) {
        if (error) {
            throw error;
        }
